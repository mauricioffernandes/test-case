...
public class TransferService {
    ...
    public void transfer(Long fromAccountId, Long toAccountId, double amount) {
        ...
        } catch (SaldoInsuficienteException | TransferenciaInvalidaException e) {
    ...
    private Account obterConta(Long accountId, String mensagemErro) {
        return accountRepository.findById(accountId)
                .orElseThrow(() -> new TransferenciaInvalidaException(mensagemErro));
    }
    ...
    private void validarTransferencia(Account fromAccount, Account toAccount, double amount) {
        ...
        if (fromAccount.equals(toAccount)) {
            throw new TransferenciaInvalidaException("A conta de origem e destino devem ser diferentes.");
        }
